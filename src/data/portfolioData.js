export const personalInfo = {
  ...
  about: "I am a passionate developer with a deep interest in software engineering and game design. I love creating immersive web experiences, exploring new technologies, and contributing to open-source projects. Constantly learning and building.",
  socials: {
...
export const highlights = [
  {
    id: 1,
    image: "https://placehold.co/100x100/1a1a1a/ffffff?text=HL1",
  ...
  {
    id: 2,
    image: "https://placehold.co/100x100/1a1a1a/ffffff?text=HL2",
...
export const projects = [
  {
    ...
    image: "https://placehold.co/400x250/1a1a1a/ffffff?text=Project+1",
  ...
  },
  {
    ...
    image: "https://placehold.co/400x250/1a1a1a/ffffff?text=Project+2",
  ...
  },
  {
    ...
    image: "https://placehold.co/400x250/1a1a1a/ffffff?text=Project+3",
  ...
  },
  {
    ...
    image: "https://placehold.co/400x250/1a1a1a/ffffff?text=Project+4",
  ...
  },
  {
    id: 5,
    title: "ClariGPT",
    image: "https://placehold.co/400x250/1a1a1a/ffffff?text=Project+5",
  ...
  },
  {
    ...
    image: "https://placehold.co/400x250/1a1a1a/ffffff?text=Project+6",
  ...
  },
  {
    ...
    image: "https://placehold.co/400x250/1a1a1a/ffffff?text=Project+7",
  ...
  },
  {
    ...
    image: "https://placehold.co/400x250/1a1a1a/ffffff?text=Project+8",
  ...
  },
  {
    ...
    image: "https://placehold.co/400x250/1a1a1a/ffffff?text=Project+9",
  ...
  },
  {
    ...
    image: "https://placehold.co/400x250/1a1a1a/ffffff?text=Project+10",
  ...
  },
  {
    ...
    image: "https://placehold.co/400x250/1a1a1a/ffffff?text=Project+11",
    description: "The Virtual OS Lab Simulator is an educational tool designed to help users understand and visualize CPU Scheduling algorithms and InterProcess Communication (IPC) between web browser workers. It provides a graphical interface to experiment with various scheduling algorithms and observe how processes communicate with each other.",
    date: "Jan 2024",
    link: ""
  },
  {
    ...
    image: "https://placehold.co/400x250/1a1a1a/ffffff?text=Project+12",
  ...
  },
  {
    ...
    image: "https://placehold.co/400x250/1a1a1a/ffffff?text=Project+13",
  ...
  {
    id: 14,
    title: "CutiePatootie: A CatBot — Discord Bot for Posting Cat Pictures",
    image: "https://placehold.co/400x250/1a1a1a/ffffff?text=Project+14",
    description: "CatBot is a simple Discord bot built with Python that posts random cat pictures to your server. (My first ever project as a High School Student :D)",
    date: "Oct 2022",
    link: ""
  }
];
...
export const publications = [
  {
    ...
    image: "https://placehold.co/400x250/222222/ffffff?text=Pub+1",
